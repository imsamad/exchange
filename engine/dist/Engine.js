...
class Engine {
  ...
  init() {
    this.orderBooks = {
      [OrderBook_1.OrderBook.getTicker("tata", "inr")]:
        new OrderBook_1.OrderBook({
          baseAsset: "tata",
          quoteAsset: "inr",
        }),
    };
  ...
  process({ message, clientId }) {
    if (message.type == "CREATE_ORDER") {
      ...
      RedisManager_1.RedisManager.getInstance().sendToApi(clientId, {
        type: "DEPTH",
        payload: Object.assign(Object.assign({}, depth), {
  ...
  createOrder(incomingOrder) {
    ...
    const order = Object.assign(Object.assign({}, incomingOrder), {
  ...
  publisWsDepthUpdates(fills, order) {
    ...
    if (order.side == "bid") {
      ...
      RedisManager_1.RedisManager.getInstance().publishMessage(
        `depth@${order.market}`,
        {
  ...
  onRamp(userId, amount, asset) {
    ...
    if (!this.userBalances[userId]) {
      ...
      if (
        !((_a = this.userBalances[userId]) === null || _a === void 0
          ? void 0
          : _a[asset])
      )
